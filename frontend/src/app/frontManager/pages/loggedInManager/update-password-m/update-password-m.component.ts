...
@Component({
  selector: 'app-update-password-m',
  templateUrl: './update-password-m.component.html',
  styleUrls: ['./update-password-m.component.css']
})
export class UpdatePasswordMComponent implements OnInit {
